...
import com.axuan.springcloud.lb.LoadBalancer;
...
public class OrderController {
    ...
    public ResultCommon getPaymentById2(@PathVariable("id") Long id) {
        ResponseEntity<ResultCommon> entity = restTemplate.getForEntity(PAYMENT_URL + "/payment/get/" + id, ResultCommon.class);
        if (entity.getStatusCode().is2xxSuccessful()) {
            return entity.getBody();
        } else {
            return new ResultCommon(444, "操作失败");
        }
    }
